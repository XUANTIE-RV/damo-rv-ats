...
const std::vector<InstField> vop_inst_fields = {
	...
	{ 19, 15, 0x00, true, RegClass::NotReg, "simm" },
...
// =============================================================================
// vmv1r.v: Copy 1 vector register. vd = vs2.
// NREG=1, simm=0x00. No alignment constraint.
// EEW=SEW, EMUL=1, evl=VLEN/SEW.
// =============================================================================
int check_illegal(c_data &cur_data)
{
	// vmv1r.v: no alignment constraint for NREG=1
	int illegal = 0;
